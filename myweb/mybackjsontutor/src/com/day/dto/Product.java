...
public class Product{
	...
	public boolean equals(Object obj) {
		...
		if (prod_no == null) {
			...
			return false;
		return true; //?˜„?ž¬ê°ì²´?˜ ?ƒ?’ˆë²ˆí˜¸(prod_no)?? ë§¤ê°œë³??ˆ˜ê°ì²´?˜ ?ƒ?’ˆë²ˆí˜¸ê°?  ê°™ì?ê²½ìš° trueë°˜í™˜
	}
	...
	//->ï¿½ï¿½Å¬ï¿½ï¿½->source->generate toString()ï¿½ï¿½ï¿½ï¿½-> ï¿½ï¿½ï¿? ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿? toString()ï¿½ï¿½ ï¿½ï¿½Å¸ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
	@Override
