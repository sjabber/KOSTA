...
--%>
<h3>EL표기법에 의한 요청전달데이터 word값:${param.word}</h3><%--요청전달데이터 없는 경우 결과:"", 요청전달데이터이름있고 값없는경우 ex)?word= 결과 : ""--%>
<h3>JSP expression에 의한 요청전달데이터 word값:<%=request.getParameter("word") %></h3><%--요청전달데이터 없는 경우 결과:null, 요청전달데이터이름있고 값없는경우 ex)?word= 결과 : ""--%>
